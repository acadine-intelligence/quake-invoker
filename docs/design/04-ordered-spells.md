...
Status: ordered recipes, the shared mana pool, and nine classic spells implemented and verified in-engine (2026-09-11). Invoking resolves the exact orb sequence against the 27-entry table; weapon recipes equip a hand; Ghost Walk (Q,Q,W), Sunstrike (E,E,E), EMP (W,W,W), Chaos Meteor (W,E,E), Tornado (Q,W,W), Deafening Blast (Q,W,E), Cold Snap (Q,Q,Q), Ice Wall (Q,Q,E), and Alacrity (W,W,E) equip a hand and cast on that hand's fire button, spending mana and starting their cooldown; the remaining spell (Forge Spirit), the portal, and reserved entries report "not castable yet" without granting anything. The remaining Forge Spirit behavior is not implemented yet. This target supersedes the order-independent recipe target in `01-invoker-mechanics.md`; that document and `05-dual-hands.md` describe the earlier slices.
